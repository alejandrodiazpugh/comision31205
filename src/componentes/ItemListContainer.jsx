        ...
        const productos = new Promise((res) => {
            setTimeout(() => {
              res([
                ...
                {id: 2, nombre: "Air Jordan XI", color: "negro", precio: 4000, stock: 20, img: "aj2"},
                {id :3, nombre: "Air Jordan IV", color: "café", precio: 4000, stock: 20, img: "aj3"},
                ...
                {id :6, nombre: "Air Jordan XIV", color: "negro", precio: 5000, stock: 10, img: "aj6"}
              ]);
            }, 2000);
          });
